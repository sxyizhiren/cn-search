...
/**
 * redis port and ip,if not set using default
 */
var redisServer;
...
/**
 * set redis server info
 * @param host
 * @param port
 * @return {Boolean}
 */
exports.setRedisServer = function(host, port){
    if(typeof host === 'string' && typeof port === 'number'){
        redisServer={
            host:host,
            port:port
        };
        console.log('>>set redis server,host:%s,port:%d',redisServer.host,redisServer.port);
        return true;
    }
    return false;
}
